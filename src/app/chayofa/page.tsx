...
import {
  amenitiesCurated, amenitiesAll, zonaTesto, direzioniDallAeroporto,
    ...
    <main className="flex-1">
      ...
      <section id="zona" className="px-6 sm:px-12 py-16 bg-wall-deep scroll-mt-16">
        <div className="max-w-3xl mx-auto">
          ...
          <h3 className="font-display font-bold mb-2 mt-8">Dall&apos;aeroporto Reina Sofía, in auto</h3>
      ...
      <section id="contatti" className="px-6 sm:px-12 py-20 bg-basalt text-wall scroll-mt-16">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-10">
            <a href="#" className="bg-teal hover:bg-teal-bright transition-colors px-8 py-3 rounded-sm font-display font-bold">
